...
ARG UV_PROJECT_ENVIRONMENT=/usr
...
RUN --mount=type=cache,target=/root/.cache/uv \
	...
	cd /vipe && \
    uv sync --locked --inexact --no-install-project --group lyra && \
    uv pip install --system --break-system-packages 'https://github.com/nvidia-isaac/cuVSLAM/releases/download/v17.0.0/cuvslam-17.0.0+cu12-cp312-abi3-manylinux_2_39_x86_64.whl'
